<?php echo '<div id="editSubjModal'.$row['id'].'" class="modal fade">
<form method="post">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input name="txt_edit_subjcode" id="txt_edit_subjcode" class="form-control input-sm" type="text" value="'.$row['subjectcode'].'" />
                </div>
                <div class="form-group">
                    <label>Subject Name: </label>
                    <input name="txt_edit_subjname" id="txt_edit_subjname" class="form-control input-sm" type="text" value="'.$row['subjectname'].'" />
                </div>
                <div class="form-group">
                    <label>Units: </label>
                    <input name="txt_edit_units" id="txt_edit_units" class="form-control input-sm" type="text" value="'.$row['units'].'" />
                </div>
                <div class="form-group">
                    <label>Course:</label>

...
<html>
    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addSemModal"><i class="fa fa-plus" aria-hidden="true"></i> Add Semester</button>  
                                ...
                                <form method="post">
                                    <table id="sy_table" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "select * from tblsemester");
                                            while($row = mysqli_fetch_array($squery))
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>'.$row['semester'].'</td>
                                                    <td><button class="btn btn-primary btn-sm" data-target="#editSemModal'.$row['id'].'" data-toggle="modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></td>
                                                </tr>
                                                ';

                                                include "editsem_modal.php";
                                            }
                                            ?>
                                        </tbody>
                                    </table>
            ...
            <?php include "addsem_modal.php"; ?>

            <?php include "manage_sem_function.php"; ?>

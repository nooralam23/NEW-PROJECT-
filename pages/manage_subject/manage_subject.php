                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addSubjectModal"><i class="fa fa-plus" aria-hidden="true"></i> Add Subject</button>  
                                ...
                                <form method="post">
                                    <table id="subject_table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "select *,s.id as sID from tblsubjects s left join tblcourse c on c.id = s.courseid left join tblsemester sm on sm.semester = s.semester");
                                            while($row = mysqli_fetch_array($squery))
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>'.$row['yearlevel'].'</td>
                                                    <td>'.$row['semester'].'</td>
                                                    <td><button class="btn btn-primary btn-sm" data-target="#editSubjModal'.$row['sID'].'" data-toggle="modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></td>
                                                </tr>
                                                ';
